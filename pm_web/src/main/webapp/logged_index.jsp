                        ...
                        <form action="rating" method="post">
                            <div>
                                ...
                                <label class="radio-inline">
                                    ...
                                    <input type="radio" name="rating" id="radio1" value="1" <c:if test="${rate.rating == 1}">checked="checked"</c:if>>1分
                                </label>
                                <label>
                                    <input type="radio" name="rating" id="radio2" value="2" <c:if test="${rate.rating == 2}">checked="checked"</c:if>>2分
                                </label>
                                <label>
                                    <input type="radio" name="rating" id="radio3" value="3" <c:if test="${rate.rating == 3}">checked="checked"</c:if>>3分
                                </label>
                                <label>
                                    <input type="radio" name="rating" id="radio4" value="4" <c:if test="${rate.rating == 4}">checked="checked"</c:if>>4分
                                </label>
                                <label>
                                    <input type="radio" name="rating" id="radio5" value="5" <c:if test="${rate.rating == 5}">checked="checked"</c:if>>5分
                                </label>
                            </div>
                            <button id="submit_btn" type="submit" class="btn btn-info btn-block">确定</button>
                        </form>
                    </div>
                </div>
                <%--</c:if>--%>
