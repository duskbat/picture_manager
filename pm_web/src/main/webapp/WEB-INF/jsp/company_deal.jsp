...
<div class="userCenterWrap">
    ...
    <div class="midCont">
        ...
        <ul class="nav nav-pills">
            <li role="presentation" class="active"><a href="company_deal" >待公司确认</a></li>
        ...
        <form id="searchOrderForm" action="<%=basePath%>searchCompanyDeal" method="get" class="navbar-form navbar-left" enctype="multipart/form-data" style="margin-left: 800px">
                    ...
                    <tr>
                        ...
                        <th>
                            <span class="scriptionLeftSpan" style="margin-left: 12px" id="${deal.id}">
                                 <button class='btn btn-primary company_edit_button' type='submit' style="width: 50px;height: 36px;padding: 1px;font-size: 14px">确认</button>
                            </span>
                        </th>
                    </tr>
                <%--</c:if>--%>
        ...
        -->
        <li>
        <a href="${pageContext.request.contextPath}/company_deal?pn=1">首页</a>
        </li>
        <!-- 如果还有前页就访问当前页码-1的页面， -->
        <c:if test="${pageInfo.hasPreviousPage}">
        <li>
        <a href="${pageContext.request.contextPath}/company_deal?pn=${pageInfo.pageNum-1}" aria-label="Previous">
        ...
        <c:if test="${page_Nums!=pageInfo.pageNum }">
        <li ><a href="${pageContext.request.contextPath}/company_deal?pn=${page_Nums}">${page_Nums}</a></li>
        </c:if>
        </c:forEach>
        </li>
        <!-- 如果还有后页就访问当前页码+1的页面， -->
        ...
        <li>
        <a href="${pageContext.request.contextPath}/company_deal?pn=${pageInfo.pageNum+1}" aria-label="Next">
        <span aria-hidden="true">&raquo;</span>
        </a>
        </li>
        </c:if>
        <li><a href="${pageContext.request.contextPath}/company_deal?pn=${pageInfo.pages}">末页</a></li>
        </ul>
        <%--</nav>--%>
        </div>
        </div>
