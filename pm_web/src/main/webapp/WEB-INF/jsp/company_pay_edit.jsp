        ...
        <div class="detailWrap">
            ...
            <div class="row detailPhotoRow">
                ...
                <div class="col-md-9 detailPhoto">
                    ...
                    <form class="form-horizontal" action="saveCompanyPay" name="formEdit" method = "post" enctype='multipart/form-data'>
                        ...
                        <span style="margin-left: 30px">
                        <c:if test="${fileUps.clientState == 1}">未确认</c:if>
                        <c:if test="${fileUps.clientState ==2}">已确认</c:if>
                        </span>
                    </div>
                    <br>
                    ...
                    <hr>
                        ...
                        <div class="scriptionLine">
                            ...
                            <span>
                                <input type="text" name="clientAccount" class="form-control" value="${fileUps.clientAccount}" placeholder="用户账号" style="width: 260px;height: 36px;border: 1px solid #204d74;">
                            </span>
                        </div>
                        <br>
                        ...
                        <div class="scriptionLine">
                            ...
                            <span>
                                <input type="text" name="companyAccount" class="form-control" value="${fileUps.companyAccount}" placeholder="公司账号" style="width: 260px;height: 36px;border: 1px solid #204d74;">
                            </span>
                        </div>
                        <br>
