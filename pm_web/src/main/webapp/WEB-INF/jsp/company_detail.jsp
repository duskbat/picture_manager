...
<div style="margin-left: 160px">
    ...
    <form class="form-horizontal" action="saveCompanyDetail" name="formEdit" method = "post" enctype='multipart/form-data'>
        ...
        <div class="row detailPhotoRow">
            ...
            <div class="col-md-4 detailPhotoDesc">
                ...
                <div class="scriptionLine">
                    ...
                    <span>
                        <input type="textarea" height="60px" value="${fileUps.instruction}" name="instruction" class="form-control" placeholder="图片描述" style="width: 260px;height: 36px;border: 1px solid #204d74;">
                    </span>
                </div>
                <hr>
                ...
                <div class="scriptionLine">
                    ...
                    <span style="margin-left: 200px">
                        <a id="hideShow_pany_detail" href="javascript:void(0);">收起/展开</a>
                    </span>
                </div>

                <hr>

                <div id="hideShow_pany_detail_content">
