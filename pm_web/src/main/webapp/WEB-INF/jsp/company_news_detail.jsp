...
<div class="userCenterWrap">
    ...
    <div class="midCont" style="margin-left: 10%">
        ...
        <div class="scriptionLine">
            ...
            <span>
                <input type="text" value="${myNews.newTitle}" name="newTitle" class="form-control" placeholder="信息标题" style="width: 260px;height: 36px;border: 1px solid #204d74;">
            </span>
        </div>
        <br>
        ...
        <div class="scriptionLine">
            ...
            <span>
                <input type="text" height="60px" value="${myNews.newSource}" name="newSource" class="form-control" placeholder="信息来源" style="width: 260px;height: 36px;border: 1px solid #204d74;">
            </span>
        </div>
        <br>

        <div class="scriptionLine">
            <span class="scriptionLeftSpan" style="font-size: 14px">信息作者</span>
            <span>
                <input type="text" height="60px" value="${myNews.newAuthor}" name="newAuthor" class="form-control" placeholder="信息来源" style="width: 260px;height: 36px;border: 1px solid #204d74;">
            </span>
        </div>
        <br>
        ...
        <%--<div class="scriptionLine">--%>
            <%--<span class="scriptionLeftSpan" style="font-size: 14px">发布内容</span>--%>
            <%--<span style="margin-left: 240px;margin-top: 30px">--%>
                <%--<button id="news_upload_button" class="btn btn-success" style="width:87px;height: 38px;padding: 3px;border-radius: 10%;font-size: 14px">文档上传</button>--%>
            <%--</span>--%>
            <%--<span style="margin-left: 80px">--%>
                <%--<input type="text" height="60px" value="" name="" class="form-control" placeholder="发布文件名" style="width: 260px;height: 36px;border: 1px solid #204d74;">--%>
            <%--</span>--%>
        <%--</div>--%>
            <div class="scriptionLine">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var uploadOption =
            {
                action: "newsFace",    // 提交目标

                name: "newsFace",            // 服务端接收的名称
