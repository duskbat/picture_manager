...
<div class="userCenterWrap">
    ...
    <div class="midCont">
        ...
        <div class="favouriteBar">
            ...
            <a href="company_video_upload" class="edit_selection" style="display: block;font-size: 16px;right: 80%;background-color: #515151">进入视频上传</a>
            ...
            <%--<a id="wait" class="edit_selection" style="display: block;font-size: 16px;right: 36%;background-color: #00ad7d;display: none">图片上传中，请稍后</a>--%>
                ...
                <a href="javascript:void(0)" id="company_upload_all_check" class="edit_selection" style="display: block;font-size: 16px;right: 15%;background-color: #66afe9">全&nbsp;选&nbsp;/&nbsp;取&nbsp;消</a>
                <a href="javascript:void(0)" id="company_upload_push_check" class="edit_selection" style="display: block;font-size: 16px;right: 8%;">批量发布</a>
                <a href="javascript:void(0)" id="company_upload_delete" class="edit_selection" style="display: block;font-size: 16px;right: 2%;background-color: #c9302c ">删&nbsp;&nbsp;&nbsp;除</a>
                    ...
                    <%--<c:if test="${picture.stateId==1 && picture.userId==user.id}">--%>
                        <div class="galleryThumb">
                            ...
                            <div class="btnWrap">
                                ...
                                <br>
                                <button id="${picture.id}${picture.id}${picture.id}" class="company_audit_small" style="display: none;width: 180px;height: 30px;padding: 3px;font-size: 15px;">发&nbsp;&nbsp;&nbsp;&nbsp;布</button>
