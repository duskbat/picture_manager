...
<div style="width: 10%;height: 30px;margin:50px auto">
    <span style="font-size: 20px;color: #4b9933">信息传递</span>
</div>
...
<%--<c:forEach items="${pageAnimal.list}" var="pageAnimal">--%>
    <%--<div class="more_animal" style="width: 200px;height: 160px;position: relative;">--%>
        <%--<img src="http://${webip}:8084/picture_bed/${pageAnimal.filePathshow}" width="200px" height="160px" style="z-index: 777;">--%>
        <%--&lt;%&ndash;<div style="z-index: 888;position: absolute;top:10px;left:10px; background-color:rgba(0,0,0,0.9);">&ndash;%&gt;--%>
            <%--<div style="z-index: 999;position: absolute;top:50px;left:70px; color: #ffffff;font-size: 24px;font-family: KaiTi">动&nbsp;物</div>--%>
        <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
    <%--</div>--%>
<%--</c:forEach>--%>
    ...
    <%--<c:forEach items="${pagePlant.list}" var="pagePlant">--%>
    <%--<div class="more_plant" style="width: 200px;height: 160px;position: relative;">--%>
        <%--<img src="http://${webip}:8084/picture_bed/${pagePlant.filePathshow}" width="200px" height="160px">--%>
        <%--<div style="z-index: 999;position: absolute;top:50px;left:70px; color: #ffffff;font-size: 24px;font-family: KaiTi">植&nbsp;物</div>--%>
    <%--</div>--%>
        <%--</c:forEach>--%>

    <%--<br>--%>

    <%--<c:forEach items="${pageScape.list}" var="pageScape">--%>
    <%--<div class="more_scape" style="width: 200px;height: 160px;position: relative;">--%>
        <%--<img src="http://${webip}:8084/picture_bed/${pageScape.filePathshow}" width="200px" height="160px">--%>
        <%--<div style="z-index: 999;position: absolute;top:50px;left:70px; color: #ffffff;font-size: 24px;font-family: KaiTi">风&nbsp;景</div>--%>
    <%--</div>--%>
        <%--</c:forEach>--%>
...
box-shadow: 5px 5px 2px #888888;">
    ...
    <div class="row" style="margin-top: 300px" >
        ...
        -->
                <li>
                    <a href="${pageContext.request.contextPath}/index_news_more?pn=1">首页</a>
                </li>
                <!-- 如果还有前页就访问当前页码-1的页面， -->
                <c:if test="${pageInfo.hasPreviousPage}">
                    <li>
                        <a href="${pageContext.request.contextPath}/index_news_more?pn=${pageInfo.pageNum-1}" aria-label="Previous">
                ...
                <c:if test="${page_Nums!=pageInfo.pageNum }">
                    <li ><a href="${pageContext.request.contextPath}/index_news_more?pn=${page_Nums}">${page_Nums}</a></li>
                </c:if>
                </c:forEach>
                </li>
                <!-- 如果还有后页就访问当前页码+1的页面， -->
                <c:if test="${pageInfo.hasNextPage}">
                    <li>
                        <a href="${pageContext.request.contextPath}/index_news_more?pn=${pageInfo.pageNum+1}" aria-label="Next">
                            <span aria-hidden="true">&raquo;</span>
                        </a>
                    </li>
                </c:if>
                <li><a href="${pageContext.request.contextPath}/index_news_more?pn=${pageInfo.pages}">末页</a></li>
            </ul>
            <%--</nav>--%>
        </div>
    </div>
