...
<div class="userCenterWrap">
    ...
    <div class="midCont">
            ...
            <div class="favouriteBar">
                ...
                <button id="animal_uncheck" >移除动物</button>
                <a href="javascript:void(0)" id="all_animal_uncheck" class="edit_selection" style="display: block;font-size: 16px;right: 180px;background-color: #66afe9">全&nbsp;选&nbsp;/&nbsp;取&nbsp;消</a>
    ...
    <div class="favouriteGalleryWrap">
        <div class="favouriteGallery layout3 globalDetail" style="position: relative; height: 0px;">
            <c:forEach items="${pageInfo.list}" var="picture">
                    <%--<c:if test="${picture.indexAnimal==2}">--%>
...
//                        alert("失败");
        ...
        // 全选/取消全部
        $("#all_animal_uncheck").click(function() {
