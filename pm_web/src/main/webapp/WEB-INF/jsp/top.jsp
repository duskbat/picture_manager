...
<nav class="navbar navbar-default">
    <div class="container">
        ...
        <div id="navbar" style="margin-top: 16px;margin-left: 100px" >
            ...
            <form id="searchTopSearch" action="<%=basePath%>index_search" method="get" class="navbar-form navbar-left" enctype="multipart/form-data" style="margin-left: 10px;margin-top: 4%">

                <input id="serchinput" type="text" name="keyword" value="${keyword1}" class="form-control" placeholder="图片搜索&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;关键词/摄影师" style="width: 260px;height: 36px;border: 1px solid #bfbfbf;">

            </form>


                <form id="searchVideoSearch" action="<%=basePath%>index_video_search" method="get" class="navbar-form navbar-left" enctype="multipart/form-data" style="display: none;margin-left: 60px">
