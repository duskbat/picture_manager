...
<div class="userCenterWrap">
    ...
    <div class="midCont">
        ...
        <div class="favouriteBar">
            ...
            <a href="company_video_auditing" class="edit_selection"
               style="display: block;font-size: 16px;right: 160px;background-color: #515151">进入视频审核页</a>
                    ...
                    <div class="galleryThumb">
                        <div class="imgWrap">
                            <a href="javascript:void(0);" onclick="company_editid(this);">
                                <img src="http://${webip}:8084/picture_bed/${picture.filePath}" id="${picture.id}"
                                     class="pictures">
                            </a>
                        </div>
...
-->
                ...
                <c:if test="${pageInfo.hasPreviousPage}">
                    <li>
                        <a href="${pageContext.request.contextPath}/company_auditing?pn=${pageInfo.pageNum-1}"
                           aria-label="Previous">
                ...
                <c:if test="${page_Nums!=pageInfo.pageNum }">
                    <li><a href="${pageContext.request.contextPath}/company_auditing?pn=${page_Nums}">${page_Nums}</a>
                    </li>
                </c:if>
                </c:forEach>
                </li>
