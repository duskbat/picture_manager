...
public class MyNews {
    ...
    public MyNews(Long id, String newTitle, String newSource, String newAuthor, Date newTime, Integer newRecord, String newAttachment, String newHtml) {
        this.id = id;
    ...
    public MyNews(String newTitle, String newSource, String newAuthor, Date newTime, Integer newRecord, String newHtml) {
        this.newTitle = newTitle;
        this.newSource = newSource;
        this.newAuthor = newAuthor;
        this.newTime = newTime;
    ...
    public MyNews(Long id, String newTitle, String newSource, String newAuthor, String newHtml) {
        this.id = id;
        this.newTitle = newTitle;
        this.newSource = newSource;
        this.newAuthor = newAuthor;
    ...
    public MyNews(Long id,String newAttachment) {
        this.id = id;
        this.newAttachment = newAttachment;
    }

    public MyNews(Long id,Integer newRecord) {
        this.id = id;
        this.newRecord = newRecord;
    }
